...
| 웹소켓 키 | `kis/실시간_웹소켓_접속키_발급.md` | 실시간 데이터 수신 시 |
...
| 실시간 호가 | `kis/해외주식 실시간호가.md` | 실시간 호가(10단계) 수신 시 |
| 실시간 체결가 | `kis/해외주식 실시간지연체결가.md` | 실시간 체결가(현재가) 수신 시 |
| 실시간 체결가(국내) | `kis/국내주식 실시간_체결가.md` | 국내 실시간 체결가 수신 시 |
