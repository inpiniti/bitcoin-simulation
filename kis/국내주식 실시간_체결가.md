...
## 개요
국내주식의 실시간 체결가 정보를 받아오는 웹소켓 API입니다.
...
| **NEW_MKOP_CLS_CODE** | 신 장운영 구분 코드 | String | Y | 2 | (1) 1:장개시전, 2:장중, 3:장종료후 ... / (2) 0:보통, 1:종가 ... |
...
| **HOUR_CLS_CODE** | 시간 구분 코드 | String | Y | 1 | 0:장중, A:장후예상, B:장전예상... |
