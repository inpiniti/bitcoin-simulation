...
개별문서 다운로드
주식잔고조회[v1_국내주식-006]정보 Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type
Method GET URL /uapi/domestic-stock/v1/trading/inquire-balance
...
[모의투자]
VTTC8434R : 주식 잔고 조회
tr*cont 연속 거래 여부 String N 1 공백 : 초기 조회
