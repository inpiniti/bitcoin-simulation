...
개별문서 다운로드
주식주문(정정취소)[v1_국내주식-003]정보 Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type
Method POST URL /uapi/domestic-stock/v1/trading/order-rvsecncl
...
tr*id 거래ID String Y 13 ※ 구TR은 사전고지 없이 막힐 수 있으므로 반드시 신TR로 변경이용 부탁드립니다.
[실전투자]
