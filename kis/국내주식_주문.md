...
개별문서 다운로드
주식주문(현금)[v1_국내주식-001]정보 Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type
Method POST URL /uapi/domestic-stock/v1/trading/order-cash
...
KRX_FWDG_ORD_ORGNO: str #계좌관리점코드
ODNO: str #주문번호
ORD_TMD: str #주문시간
