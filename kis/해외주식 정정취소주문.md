...
개별문서 다운로드
해외주식 정정취소주문[v1_해외주식-003]정보 Method, URL, 실전 Domain, 모의 Domain, Format, Content-Type
Method POST URL /uapi/overseas-stock/v1/trading/order-rvsecncl
...
(EX. "CANO" : "12345678", "ACNT*PRDT_CD": "01",...)
요청
Header
...
VTTS0306U : 심천 취소 주문
VTTS0312U : 베트남 취소 주문
tr*cont 연속 거래 여부 String N 1 tr_cont를 이용한 다음조회 불가 API
...
ACNT*PRDT_CD 계좌상품코드 String Y 2 계좌번호 체계(8-2)의 뒤 2자리
...
(해외주식*주문 API ouput ODNO
or 해외주식 미체결내역 API output ODNO 참고)
RVSE*CNCL_DVSN_CD 정정취소구분코드 String Y 2 01 : 정정
02 : 취소
